...
public class HomeMaintenanceModel extends BaseMaintenanceModel {
	...
	public HomeMaintenanceModel(String _time, String customer_name, String driver_name, String _carNum,
			...
			String _reoil,String _cermr, String _ccmrq, String green2, String txt30, String _mdlcd, String _vocNum, String _kunnr, String delay, String vbeln, String gubun, String reqNo, String atvyn) {
		super(customer_name, driver_name, _carNum, _address, _tel, _time, _carname,
				...
				street, drv_mob, green2, txt30, _mdlcd, _vocNum, _kunnr, delay, null, null, vbeln, gubun, reqNo, atvyn);
