...
public class Menu2_Activity extends BaseActivity implements ConnectInterface, OnClickListener {
    ...
    // yunseung 2019.05.07 정비유형이 타이어 또는 일반일 경우 대상구분 영억이 생김. IoT 관련 업데이트
    private LinearLayout mLlMenuGubunArea = null;
    private Button mBtnMenuGubun = null;
    ...
    private void initView() {
        ...
        mLlMenuGubunArea = (LinearLayout) findViewById(R.id.menu_gubun_area);
        mBtnMenuGubun = (Button) findViewById(R.id.menu_gubun);
        mBtnMenuGubun.setOnClickListener(this);


        bt_process.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void afterTextChanged(Editable s) {
                if (s.toString().equals("일반") || s.toString().equals("타이어") || s.toString().equals("전체")) {
                    mLlMenuGubunArea.setVisibility(View.VISIBLE);
                } else {
                    mLlMenuGubunArea.setVisibility(View.GONE);
                }
            }
        });
    }
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            ...
            case R.id.menu_gubun:
                pwMULTY.show("PM319", mBtnMenuGubun);
                break;
        }
    }
    ...
    private void goSearch() {
        ...
        cc.getZMO_1100_RD03(carnum, process, action, date1, date2, getAtvyn());
    }
...
//		sqlite.close();
    ...
    private String getAtvyn() {
        String atvyn = "A";
        switch (mBtnMenuGubun.getText().toString()) {
            case "전체" :
                atvyn = "A";
                break;
            case "일반" :
        ...
        if (mLlMenuGubunArea.getVisibility() != View.VISIBLE) {
            atvyn = "A";
        }
