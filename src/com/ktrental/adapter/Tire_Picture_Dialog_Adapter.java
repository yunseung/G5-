...
public class Tire_Picture_Dialog_Adapter extends BaseCommonAdapter<PM081> {

	private int layout;
	
//	private int checkPosition = -1;
	
	private ArrayList<PM081> list;
...
//	private ArrayList<Integer> rear;
	...
	public Tire_Picture_Dialog_Adapter(Context context, int layout, ArrayList<PM081> list, Tire_Picture_Dialog tpd, int mode)
	{
		super(context);
		mContext = context;
		this.layout = layout;
...
//		final int final_position = position;
		final PM081 item = list.get(position);
...
//				checkPosition = final_position;
		...
		*/
		...
		if(item.ZCODEVT.equals("차량번호판")||item.ZCODEVT.contains("기타")||item.ZCODEVT.equals("계기판"))
