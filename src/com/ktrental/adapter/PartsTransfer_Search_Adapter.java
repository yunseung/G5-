...
public class PartsTransfer_Search_Adapter extends ArrayAdapter<PARTS_SEARCH> {
    ...
    public PartsTransfer_Search_Adapter(Context context, int textViewResourceId, ArrayList<PARTS_SEARCH> items) 
        {
...
//        tv3.setText(item.REQUEST);//부품명
//        tv2.setText(item.MEINS);//단위
