...
public class Menu4_Tire_Adapter_PM056 extends BaseCommonAdapter<PM056> {
	
    private int layout;
	private int checkPosition = -1;
	private ArrayList<PM056> list;
	private Context context;

	public Menu4_Tire_Adapter_PM056(Context context, int layout, ArrayList<PM056> list)
	    {
		super(context);
		mContext = context;
		this.layout = layout;
	 ...
	 public View getView(int position, View convertView, ViewGroup parent)
    	 ...
    	 final PM056 item = list.get(position);
    	 ...
    	 if(Menu2_1_Activity.pm056_del_arr.contains(item.ZCODEV)) row1.setImageResource(R.drawable.check_on);
