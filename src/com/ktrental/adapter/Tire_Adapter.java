...
public class Tire_Adapter extends BaseCommonAdapter<PM081> {
	...
	public Tire_Adapter(Context context, int layout, ArrayList<PM081> list)
	    {
		super(context);
		mContext = context;
		this.layout = layout;
	 ...
	 public View getView(int position, View convertView, ViewGroup parent)
    	 ...
    	 if(TireFragment.pm081_del_arr.contains(item.ZCODEV)) row1.setImageResource(R.drawable.check_on);
