...
public class Tire_Picture_Dialog_Adapter_PM056 extends BaseCommonAdapter<PM056> {
...
//	private ArrayList<Integer> rear;
	...
	public Tire_Picture_Dialog_Adapter_PM056(Context context, int layout, ArrayList<PM056> list, Tire_Picture_Dialog tpd, int mode)
	{
		super(context);
		mContext = context;
		this.layout = layout;
