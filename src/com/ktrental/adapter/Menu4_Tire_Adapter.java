...
public class Menu4_Tire_Adapter extends BaseCommonAdapter<PM081> {
	...
	public Menu4_Tire_Adapter(Context context, int layout, ArrayList<PM081> list)
	    {
		super(context);
		mContext = context;
		this.layout = layout;
...
//    	 if(Menu2_1_Activity.pm081_del_arr_menu4.contains(item.ZCODEV)) row1.setImageResource(R.drawable.check_on);
