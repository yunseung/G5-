...
public class Inventory_Search_Adapter extends ArrayAdapter<PARTS_SEARCH> {
    ...
    public Inventory_Search_Adapter(Context context, int textViewResourceId, ArrayList<PARTS_SEARCH> items) 
        {
