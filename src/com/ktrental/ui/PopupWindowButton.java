...
public class PopupWindowButton extends Button {
	...
	public PopupWindowButton(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public PopupWindowButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public PopupWindowButton(Context context, AttributeSet attrs, int defStyle) {
