...
public class SMSPopup extends BaseTouchDialog implements View.OnClickListener {
	...
	public SMSPopup(Context context, BaseMaintenanceModel model) {
		super(context);
		...
		mTvCarNum.setText(model.getCarNum());
