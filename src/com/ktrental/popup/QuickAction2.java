 ...
 */
public class QuickAction2 extends PopupWindows implements OnDismissListener
{
        ...
        container.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v)
                ...
                if (mItemClickListener != null)
                    {
                    mItemClickListener.onItemClick(QuickAction2.this, pos,
                                                   actionId);
                    }
...
//        mRootView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
    ...
    public void show(View anchor, int popWidth, int popHeight)
        ...
        Rect anchorRect = new Rect(location[0] - valWidth, location[1],
            location[0] + anchor.getWidth() - valWidth, location[1]
                - valheight + anchor.getHeight() - valheight);
    ...
    public interface OnActionItemClickListener
    {
        ...
        public abstract void onItemClick(QuickAction2 source, int pos,
                                         int actionId);
    }
