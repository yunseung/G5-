...
import com.ktrental.beans.M028;
import com.ktrental.common.DEFINE;

import java.util.ArrayList;


public class Popup_Window_M028 extends Popup_Window  {
	...
	public Popup_Window_M028(Context context) {
		super(context);
		this.context = context;

		initViewSettings(initM028());

	}
	
    String TABLE_NAME = "O_ITAB1";
    public ArrayList<M028> m028_arr;
    private ArrayList<M028> initM028()
        {
        m028_arr = new ArrayList<M028>();
        ...
        Cursor cursor = sqlite.rawQuery("select ZCODEV, ZCODEVT from " + TABLE_NAME + " where ZCODEH = 'M028'", null);
        M028 pm = new M028();
        pm.ZCODEV = " ";
        pm.ZCODEVT = "전체";
        m028_arr.add(pm);
...
//        sqlite.close();
	...
	private void initViewSettings(ArrayList<M028> list)
	    {
