...
public class Popup_Window_PM023 extends Popup_Window  {
	...
	public Popup_Window_PM023(Context context) {
		super(context);
		this.context = context;

		initViewSettings(initPM023());

	}
	
    String TABLE_NAME = "O_ITAB1";
    public ArrayList<PM023> pm023_arr;
    private ArrayList<PM023> initPM023()
        ...
        Cursor cursor = sqlite.rawQuery("select ZCODEV, ZCODEVT from " + TABLE_NAME + " where ZCODEH = 'PM023'", null);
        PM023 pm = new PM023();
        pm.ZCODEV = " ";
        pm.ZCODEVT = "전체";
        pm023_arr.add(pm);
...
//        sqlite.close();
	...
	private void initViewSettings(ArrayList<PM023> list)
	    {
